...
*/
let 키 = Number(prompt('키(cm)')) / 100
let 몸무게 = Number(prompt('몸무게(kg)'))
BMI = 몸무게 / (키 * 키)
...
let 아이디 = prompt('아이디')
let 이메일 = prompt('이메일')
if (아이디 == 'admin' | 이메일 == 'admin@test.com') {
    console.log('관리자');}
else {console.log ('일반 사용자');}
...
if(점수 >= 90) {document.querySelector('점수').innerHTML = 'A'}
else if(점수 >= 80) {document.querySelector('점수').innerHTML = 'B'}
else {document.querySelector('점수').innerHTML = 'C'}
...
if(나이 >=20 && 나이 < 30) {console.log("이벤트 대상입니다")}
...
let likeCount = 3
for ( likeCount = 3 ; likeCount < 5 ; likeCount++)
...
let todoList1 = prompt('새로운 할 일을 입력하세요')
