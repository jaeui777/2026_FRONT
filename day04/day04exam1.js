...
// 비가 오면 우산챙기고 그렇지 않으면 우산 두고간다.
// 프로젝트 / 실무 : 어떠한 기능에 따른 상황 판단

// 1. if문 : if(조건식) 실행문, 조건식 결과가 true(참) 이면 실행문을 처리
...
// 4. if문 ~ else if ~ else if ~ else : 다수 조건 : 다수 조건에 따른 true/false 결과를 1개만 처리
if ( 10 > 3 ) {console.log( '5.10은 3보다 크다');}
else if ( 10 > 2 ) { console.log( '5. 10은 2보다크다');}
else if ( 10 > 1) { console.log( '5. 10은 1보다 크다');}
else { console.log ('5. 거짓');}

// vs if if if : 다수 조건에 따른 다수 결과를 처리
if ( 10 > 3 ) {console.log( '5.10은 3보다 크다');}
if ( 10 > 2 ) { console.log( '5. 10은 2보다크다');}
...
if(길이 >= 12){console.log('강함');} // 4. 출력 분기 : 더 큰 수부터
...
/*
let seatList = [ 'O', 'X', 'O' ]; // 0. 미리 주비한 데이터
let 선택번호 = Number(prompt('좌석번호:0~2'))// 1. 입력받기 2. 저장하기 *인덱스란? 배열내 저장들의 순서번
...
else if (게임점수 >= 500) {console.log( 'B급')}
else {console.log( 'B급')}
*/
...
if(나이 < 8) {console.log('무료')}
else if (나이 >= 8) {console.log('5000원')}
else if (나이 < 65) {console.log('10,000원')}
...
if(음료번호 > 0 || 음료번호 >2 ){
    ...
    console.log(`선택하신 음료는 ${drinkNames(음료번호) }입니다. 가격은 ${drinkPrices(음료번호) }입니다.`)
)
