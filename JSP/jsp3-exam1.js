...
let 월 = Number(prompt('월(Month)을 입력하세요'))
if(월 = 3 & 4 & 5) {console.log(봄)}
else if(월 = 6 & 7 & 8) {console.log(여름)}
else if(월 = 9 & 10 & 11) {console.log(가을)}
else if(월 = 12 & 1 & 2) {console.log(겨울)}
...
let 차량위치 = carArray.indexOf(차량번호);
if (차량위치 != -1) {
    console.log(`차량 위치는 ${locationArray[차량위치]}입니다.`);
} else {
...
let courseList = ['수학', '영어', '과학', '국어'];
let 제외과목 = prompt('제외하고 싶은 과목명을 입력하세요.');
let 과목위치 = courseList.indexOf(제외과목);
if (과목위치 != -1) {
